...
const Post = () => {
  return (
    <div>
      <Link
        href="/feed/1"
        className="flex flex-col items-center bg-transparent border border-gray-200 rounded-lg shadow md:max-w-xl"
      >
        <div className="relative w-full h-96 ">
          <Image
            ...
            alt="post"
            fill
            className="absolute object-contain rounded-t-lg"
          />
        </div>
        <div className="flex flex-col justify-between p-4 leading-normal">
          <p className="mb-3 font-semibold text-gray-500 text-xs">
